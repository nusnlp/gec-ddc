...
class nucle_doc:
    ...
    def buildSentence(self, sentstr, dpnode, constituentstr, poslist, chunklist, wordTokenizer):
        self.sentences[-1].append(nucle_sent(sentstr, dpnode, constituentstr, poslist, chunklist, wordTokenizer))
...
class nucle_sent:
    def __init__(self, sentstr, dpnode, constituentstr, poslist, chunklist, wordTokenizer):
        self.sentstr = sentstr
        self.words = [tok.text for tok in wordTokenizer.tokenizer(sentstr)]
        self.dpnodes = dpnode
