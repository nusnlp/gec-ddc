...
from rl_from_file import departureLossRL_from_file
import torch
...
class LabelSmoothedCrossEntropyReinforceCriterion(FairseqCriterion):
    def __init__(self, args, task):
        ...
        from_file = True
        if from_file:
            self.loss_rl = departureLossRL_from_file(device=None, word_alphabet=None, vocab_size=None, args=args, src_dict=task.target_dictionary)  # no .cuda()??
        else:
