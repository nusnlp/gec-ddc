...
@register_model('convlm')
class FConvCustomLanguageModel(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        import sys
        return FConvCustomLanguageModel(decoder)
...
@register_model_architecture('convlm', 'convlm')
